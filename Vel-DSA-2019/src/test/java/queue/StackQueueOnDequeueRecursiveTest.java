...
public class StackQueueOnDequeueRecursiveTest {

	@Test
	public void testtackQueueOnDequeueRecursive() {
		StackQueueOnDequeueRecursive queue = new StackQueueOnDequeueRecursive();
